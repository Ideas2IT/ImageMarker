...
// For storing the history of images saved and updated sequentially
var nextHistory;
var currentHistory;

// The initial image loaded even if it may be a blank space
var initialImage;

// Stacks used for manual undo and redo operations
var currentPointsArray;
var poppedPointsArray;

// For holding the current image state
var currentImage;
var currentImageId;
...
var tool;
var funds;
var tool_default = 'pencil'; // By default the tool will be pencil
...
function initCanvas () {
	...
	//All the tools get activaed on mouse clicked on it
...
tools.pencil = function () {
	...
	// When we start holding down the mouse button.
